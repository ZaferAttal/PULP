...
add_files -norecurse -scan_for_includes $SRC_UDMA_HYPER
...
add_files -norecurse -scan_for_includes $SRC_HCI
add_files -norecurse -scan_for_includes $SRC_FPU_INTERCO
add_files -norecurse -scan_for_includes $SRC_PULP_CLUSTER
